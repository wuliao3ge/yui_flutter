...
class NavigatorManger {
  ...
  void addWidget(BasefulWidgetState widgetName) {
    _activityStack.add(widgetName.getClassName());
  }

  void removeWidget(BasefulWidgetState widgetName) {
    _activityStack.remove(widgetName.getClassName());
  }

  bool isTopPage(BasefulWidgetState widgetName) {
  ...
  bool isSecondTop(BasefulWidgetState widgetName) {
    if (_activityStack == null) {
      return false;
    }
    try {
